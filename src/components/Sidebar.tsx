  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        {
          page: 'gapanalysis', label: 'Gap Analysis',
    ...
    },
    {
      ...
      items: [
        { page: 'risk',     label: 'Risk Acceptance',  count: riskCount,    icon: 'M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
        { page: 'waivers',  label: 'Waivers',          count: waiverCount,  icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
        {
          page: 'skipped', label: 'Skipped Controls',
    ...
    },
    {
      ...
      items: [
        {
          page: 'catalogue', label: 'Controls Catalogue',
        ...
        { page: 'exploitpath', label: 'Exploit Paths',    danger: true, icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
        {
          page: 'blastradius', label: 'Blast Radius',
        ...
        {
          page: 'depgraph', label: 'Dependency Graph',
        ...
        {
          page: 'modules', label: 'Module Scores',
        ...
        {
          page: 'changes', label: 'Changes & Drift',
    ...
    },
    {
      ...
      items: [
        ...
        {
          page: 'secrets', label: 'Secret Scanner',
    ...
    },
    {
      ...
      items: [
        ...
        { page: 'runs',    label: 'Run History',    count: runs.length > 0 ? runs.length : undefined, icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z' },
...
export default function Sidebar({
  ...
  maturityLevel, settings, waiverCount, riskCount, failCount,
  navigate, onShowRunModal, onLogout,
}: SidebarProps) {
  const matMeta = getMaturityMeta(maturityLevel)
  const hide = settings.hideDisabledMenuItems

  const allSections = buildNavSections(run, runs, settings, waiverCount, riskCount, failCount)
