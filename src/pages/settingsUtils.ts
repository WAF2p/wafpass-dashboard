...
export const MATURITY_META = [
  {
    ...
    color: '#f59e0b', textColor: '#ffffff', bg: 'rgba(245,158,11,',
  ...
  },
  {
    ...
    color: '#0094FF', textColor: '#ffffff', bg: 'rgba(0,148,255,',
  ...
  },
  {
    ...
    color: '#0891b2', textColor: '#ffffff', bg: 'rgba(8,145,178,',
  ...
  },
  {
    ...
    color: '#7c3aed', textColor: '#ffffff', bg: 'rgba(124,58,237,',
  ...
  },
  {
    ...
    color: '#059669', textColor: '#ffffff', bg: 'rgba(5,150,105,',
